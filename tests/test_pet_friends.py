...
def test_get_api_key_for_no_valid_email(email = 'New@rambler.ru', password = valid_password):
    """ Проверка, негативный тест, ввод неверного e-mail """
...
def test_get_api_key_for_no_valid_password(email=valid_email, password='159753'):
    """ Проверка, негативный тест, ввод неверного пароля """
...
def test_add_new_pet_with_no_valid_age(name = 'Кэмел', animal_type = 'верблюд', age = 'вот это чушь', pet_photo = 'images/Dog1.jpg'):
    """ Проверка добавления питомца с вводом нечисловой переменной в поле возраста"""
...
def test_add_new_pet_with_four_age_nmber(name = 'Рой', animal_type = 'Барсук', age = '1234', pet_photo = 'images/Dog1.jpg'):
    """ Проверка добавление питомца с четырехзначным числом в поле возраст"""
